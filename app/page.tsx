        ...
        <section className="py-20">
          <div className="max-w-6xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-slate-600 mb-12 max-w-2xl mx-auto leading-relaxed">
              Discover insights, stories, and ideas through carefully crafted articles.
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {posts.map((post, index) => (
                  <Card key={post._id} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 bg-white/80 backdrop-blur-sm border-white/20 overflow-hidden">
              ...
              <div className="text-center py-16">
                ...
                <p className="text-lg text-slate-600 mb-8 max-w-md mx-auto">
                  This blog is just getting started. Check back soon for fresh content and insights.
                </p>
                <Link href="/admin">
        ...
        <footer className="border-t border-white/20 bg-white/80 backdrop-blur-sm py-12">
          <div className="max-w-6xl mx-auto px-4 text-center">
            <div className="flex items-center justify-center space-x-3 mb-4">
              ...
              <span className="text-xl font-semibold text-slate-900">My Blog</span>
            </div>
